...
FixedHeader.prototype = {
	 ...
	 * that the two have identical structure - no exceptions checking is performed to that
	 * fact.
	...
	"fnEqualiseHeights": function ( parent, original, clone )
	{
		...
		$(parent+' tr', clone).each( function (k) {
			...
			// This is nasty :-(. IE has a sub-pixel exceptions even when setting
			...
			// is a sub-pixel rounding exceptions
